export default function Contact() {
  return (
    <div id='contact' className="px-6 overflow-hidden	h-screen min-h-[600px] w-full flex flex-col items-center justify-center relative gap-2   sm:gap-4 sm:px-16   2xl:gap-10">
      ...
      <div className="circle_contact-down"></div>
      <div className="circle_contact-down-2"></div>
      <footer className="w-full h-16 flex items-start justify-center absolute bottom-0   sm:h-24   2xl:h3-2">
        <ul className="w-auto h-5 flex items-center justify-center gap-6   sm:gap-10">
          <li className="font-semibold text-xs text-[#0D0D0D]   2xl:text-sm"><h4>DANIEL PRIETO</h4></li>
          <li className="w-px h-4 bg-[#0D0D0D]   2xl:h-5"></li>
