...
const ButtonView = ({ url }) => {
  return (
    <a href={url} target='_blank' className="font-semibold text-sm text-[#0D0D0D] dark:text-[#FFFFFF] flex items-center justify-center gap-1   lg:text-lg lg:gap-6   2xl:text-2xl 2xl:gap-10">
      View
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-2 h-2   lg:w-4 lg:h-4   2xl:w-6 2xl:h-6">
...
export default function MoreWorks() {
  return (
    <article className="px-6 pt-16 flex flex-col   sm:px-16   lg:px-24   2xl:px-36">
      <h2 id='more-works' className="mb-16 font-bold text-3xl text-[#0D0D0D] dark:text-[#FFFFFF]   lg:text-5xl   2xl:text-6xl 2xl:mb-24">More Works<span className='text-[#F3D335]'>.</span></h2>
